...
Removing itinerary aggregation substantially weakens the lower bound. Without super-itineraries, the relaxation permits unrealizable revenue from fractional resource allocations that form invalid offer sets, inflating the bound and reducing its certification value. This confirms that itinerary aggregation is the primary driver of bound strength in the \algoNotation framework.
