...
% The ability of DDD to simultaneously pull up the lower bound (through relaxation) and push down the upper bound (through Vantage) confirms its effectiveness as a comprehensive solution strategy for the integrated \problemName.
