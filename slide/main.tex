...
\title[考虑乘客选择的服务网络设计]{考虑乘客选择的服务网络设计}
...
\begin{frame}[plain]
    \begin{tikzpicture}[remember picture,overlay]
        \node[anchor=center] at (current page.center) {\includegraphics[width=\paperwidth,height=\paperheight]{my_content/asset/cover.png}};
    \end{tikzpicture}
\end{frame}
