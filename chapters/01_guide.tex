...
后续示例章节依次演示：\ref{chap:introduction}（标题、列表、字体）、\ref{chap:float}（图、表、算法、代码）、\ref{chap:math}（数字单位、公式、定理）、\ref{chap:reference}（参考文献、脚注、交叉引用）、\ref{chap:conclusion}（总结与展望），附录则示范 \cs{appendixsection}/\cs{appendixsubsection} 的用法。
