...
\]
因为精细路由中的反向弧都是环绕的，即 $\arcNega^{\mathrm{full}}$ 为空，由引理~\ref{lem:fleet_avail.wrap} 可得 $|\arcPosi^{\mathrm{full}}|=\wrapnum_{fk}$。
