我们首先将一般 ATFP 解的结构分解为循环路由的平坦结构，以此开始预备分析。

对于 ATFP 解 $\solution = (\fleetAssignVar, \shareVar, \outsideShareVar)$，我们可以定义其对应的路由方案 $\routingPlan(\solution)$ 或 $\routingPlan(\fleetAssignVar)$ 如下：
\[
