\paragraph*{约束~(\ref{constr:relax.choice.limit})} 因为 $(\bar{\fleetAssignVar}, \bar{\shareVar}, \bar{\outsideShareVar})$ 对 $\model{\discretizationFull}$ 可行，由约束~(\ref{constr:main.choice.limit}) 我们有：
\[
    ...
    = 1
\]
由 $\eqClassByPathSig$ 中等价类的不相交性和穷尽性，我们有
\[
    \left(\frac{\adjOutAttr_{mp}}{\outAttr_{mp}}\right) \bar{\outsideShareVar}_{mp}
    ...
    = 1
\]
由定义~(\ref{def:relax.shadowAttrSuper})，显然有
\[
...
\[
    ...
    \le 1
\]
因此，约束~(\ref{constr:relax.choice.limit}) 得到满足。
